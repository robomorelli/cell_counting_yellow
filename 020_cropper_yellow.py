...
if __name__ == "__main__":
    ...
    parser.add_argument('--x_distance', nargs="?", type = int, default = 400,  help='distance beetwen cuts points on the x axis')
    parser.add_argument('--y_distance', nargs="?", type = int, default = 400,  help='distance beetwen cuts points on the y axis')
